...
\bibliography{auto/AnnoNLP/papers.bib}
\bibliography{auto/BioNLP/papers.bib}
\bibliography{auto/COIN/papers.bib}
\bibliography{auto/FEVER/papers.bib}
\bibliography{auto/DeepLo/papers.bib}
\bibliography{auto/Discomt/papers.bib}
\bibliography{auto/LANTERN/papers.bib}
\bibliography{auto/WAT/papers.bib}
...
\bibliography{auto/LOUHI/papers.bib}
\bibliography{auto/MSR/papers.bib}
\bibliography{auto/WNUT/papers.bib}
\bibliography{auto/NLP4IF/papers.bib}
\bibliography{auto/NewSum/papers.bib}
\bibliography{auto/TextGraphs/papers.bib}
...
\clearpage
%% Child care info %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{content/fmatter/childcare-info}
...
%%%%%%%%%%%% WORKSHOPS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\setdaydateyear{Sunday--Monday}{November 3--November 4}{2019}
\input{content/workshops/workshops}


%% MAIN CONFERENCE %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\setdaydateyear{Tuesday}{November 5}{2019}
\input{content/day1/day1}

\setdaydateyear{Wednesday}{November 6}{2019}
\input{content/day2/day2}

\setdaydateyear{Thursday}{November 7}{2019}
