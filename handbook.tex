...
%\fancyfoot[C]{}
\includepdf[pages={1}]{content/fmatter/EMNLP18_cover.pdf}
...
\vspace*{6in}
\begin{linez}
\emph{Cover design by Dominique De Brabanter}\index{De Brabanter, Dominique}
\emph{Cover photo bys}\index{}
\emph{Deep gratitude to Joachim Bingel for invaluable advice with creating this handbook}\index{Bingel, Joachim}
    \emph{Handbook assembled by Kuan-Hao Huang and Kai-Wei Chang and proofread by He He}\index{Huang, Kuan-Hao}\index{Chang, Kai-Wei}\index{He, He}
\emph{Printing by }
\end{linez}
...
\cleardoublepage
\includepdf[pages=-]{content/local-guide/local-guide.pdf}
