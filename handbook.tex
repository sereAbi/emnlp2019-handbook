...
\vspace*{6in}
\begin{linez}
\emph{Cover design by }\index{Bunescu, Aurelia}
...
\emph{Deep gratitude to Joachim Bingel for invaluable advice with creating this handbook}\index{Bingel, Joachim}
    \emph{Handbook assembled by Kai-Wei Chang and proofread by He He}\index{Chang, Kai-Wei}\index{He, He}
...
%\input{auto/papers/Saturday-Session-5D.tex}

%\input{auto/papers/Sunday-Session-4F.tex}
