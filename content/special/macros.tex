...
\newcommand{\posterabstract}[1]{%
  ...
  \begin{minipage}{\linewidth}%
    \label{#1}%
          {\bfseries\normalsize\papertitle{#1}}\vspace{0.1em}\\
          \normalsize\paperauthor{\citefullauthornames{#1}} \vspace{0.1em}\\
  \noindent{\small\input{auto/abstracts/#1}}
  ...
  \begin{minipage}{\linewidth}%
    \label{#5}%
      %\rule{\linewidth}{1pt}\linebreak
          {\bfseries\normalsize\papertitle{#5}}\vspace{0.1em} \\
          \hfill\normalsize\paperauthor{\citefullauthornames{#5}}
%      {\small #1 #2 --- #4}\vspace{.5ex}\\
          \hfill {\small #2} \vspace{0.1em}\\ 
      \noindent{\small\input{auto/abstracts/#5}}
...
\newenvironment{FourSessionOverview}[6]{
  \section[#1]{#1 Overview -- #2}
  \setheaders{#1}{#2}
  {\large {\bf Oral tracks}}
  \begin{center}
    \righthyphenmin2
    \sloppy
      \vspace{-2em}
      \begin{tabular}{>{\RaggedRight}p{1.1in} >{\RaggedRight}p{1.1in} >{\RaggedRight}p{1.1in} >{\RaggedRight}p{1.1in}}
      
          \bf Track A & \bf Track B & \bf Track C & \bf Track D\\
          \it #3 & \it #4 & \it #5 & \it #6\\
          \TrackALoc & \TrackBLoc & \TrackCLoc &\TrackDLoc \\
      \midrule\midrule}
{\midrule\midrule\end{tabular}\end{center}}
...
\newenvironment{ThreeSessionOverview}[5]{
  ...
  \begin{center}
    \righthyphenmin2
    \sloppy
    \begin{tabular}{>{\RaggedRight}p{1.4in} >{\RaggedRight}p{1.4in} >{\RaggedRight}p{1.4in}}
      
      \bf Track A & \bf Track B & \bf Track C \\
      \it #3 & \it #4 & \it #5 \\
